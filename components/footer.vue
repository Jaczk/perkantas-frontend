<template>
  <footer>
    <div class="sticky inset-x-0 bottom-0 z-50 px-5 pt-6 pb-3 bg-other">
        ...
        <div class="px-5 mx-4 mt-6 basis-1/2">
          <div class="grid grid-cols-1 gap-3">
            ...
            <p class="text-justify">
              ...
              Badan Pengurus Perwakilan/BPP, 20 Badan Pengurus Ranting/BPR, dan
              30 lebih kota perintisan, dilayani oleh lebih dari 200 staf penuh
              waktu yang dibantu oleh alumni yang terlibat aktif dalam
            ...
            <div class="flex flex-row p-2">
              <a href="https://www.facebook.com/PerkantasSMG/?locale=id_ID"
                ><img
                  src="/assets/images/Facebook_icon_2013.svg.png"
                  alt=""
                  class="h-10 px-2 hover:scale-110"
              /></a>
              <a href="https://www.instagram.com/perkantas.smg/"
                ><img
                  src="/assets/images/Instagram_logo_2016.svg.png"
                  alt=""
                  class="h-10 px-2 hover:scale-110"
              /></a>
              <a href="https://twitter.com/PerkantasSMG"
                ><img
                  src="/assets/images/Logo_of_Twitter.svg.png"
                  alt=""
                  class="h-10 px-2 hover:scale-110"
              /></a>
              <a href="#"
      ...
      <div class="content-center p-3 text-center mt-7">
        Copyright &copy;
        <a href="https://buildwithangga.com/">BuildWithAngga</a> for Sistem
        Informasi Inventaris Perkantas Semarang <br />
        Made with &hearts; by Chris, Dzul, and Dimas
      </div>
    </div>
  </footer>
</template>
